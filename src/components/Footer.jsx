        ...
        <footer id="footer" className="bg-mitake-dark text-white py-10 md:py-20 border-t border-white/5 relative z-10">
            <div className="container mx-auto px-4 md:px-6">
                    ...
                    <div className="space-y-4 md:space-y-6">
                        ...
                        <div className="space-y-3 text-sm text-gray-400 font-light">
                            <div className="flex justify-between gap-4">
                                <span>Mercredi</span>
                                <span className="text-right">11h30-14h00</span>
                            </div>
                            <div className="flex justify-between gap-4">
                                <span>Mar, Jeu, Ven</span>
                                <span className="text-right">11h30-14h00<br/>18h00-21h00</span>
                            </div>
                            <div className="flex justify-between gap-4">
                                <span>Samedi</span>
                                <span className="text-right">18h00 - 21h00</span>
                            </div>
                ...
                <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
                    <p className="text-xs text-gray-600">© 2026 Mitake Ramen. Tous droits réservés.</p>
