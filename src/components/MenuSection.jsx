            ...
            <div className="relative min-h-[60vh]">
                <AnimatePresence mode="wait">
                    {activeTab === 'atelier' ? (
                        ...
                        >
                            {/* Sticky Image Left */}
                            <div className="w-full lg:w-1/2 h-[30vh] md:h-[40vh] lg:h-auto lg:min-h-[60vh] lg:sticky lg:top-32 overflow-hidden self-start">
                                <div
                                ...
                                >
                                    <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-transparent to-transparent lg:bg-gradient-to-r lg:from-transparent lg:to-mitake-black"></div>
                                </div>
                            </div>

                            {/* Menu List Right (Accordions) */}
                            <div className="w-full lg:w-1/2 p-4 md:p-6 lg:p-16 bg-mitake-black">
                                <div className="space-y-4 md:space-y-6">
                                    {filteredMenu.map((category, idx) => (
                                        <div key={idx} className="border-b border-white/10 pb-4">
                                            <button
                                                onClick={() => toggleCategory(category.categorie)}
                                                className="w-full flex justify-between items-center py-3 md:py-4 group"
                                            >
                                                ...
                                                <div className="text-mitake-gold/70 group-hover:text-mitake-gold transition-colors">
                                                    {expandedCategory === category.categorie ? <Minus size={20} /> : <Plus size={20} />}
                                                </div>
                                            </button>
                                                        ...
                                                        <div className="space-y-4 py-4 md:py-6">
                                                            {category.articles.map((item, i) => {
                                                                ...
                                                                return (
                                                                    <div
                                                                        key={i}
                                                                        className={`group/item relative p-4 rounded-lg border transition-all duration-300 ${isUnavailable
                                                                    ...
                                                                    >
                                                                        <div className="flex justify-between items-start gap-4">
                                                                            <div className="flex-1">
                                                                                <h4 className={`text-sm md:text-base font-medium mb-1 ${isUnavailable
                                                                                    ? 'text-gray-500'
                                                                            ...
                                                                            <div className="flex items-center gap-3 shrink-0">
                                                                                <span className={`font-serif text-sm md:text-base ${isUnavailable ? 'text-gray-600' : 'text-mitake-gold'
                                                                                    }`}>
                                                                                    {item.prix}
                                                                                </span>
                                                                                {isUnavailable ? (
                                                                                    ...
                                                                                    <button
                                                                                        ...
                                                                                        className="w-8 h-8 rounded-full bg-mitake-gold/10 border border-mitake-gold/30 flex items-center justify-center text-mitake-gold hover:bg-mitake-gold hover:text-black transition-all duration-300 transform hover:scale-110"
                        ...
                        >
                            ...
                            <div className="w-full lg:w-1/2 h-[30vh] md:h-[40vh] lg:h-auto lg:min-h-[60vh] lg:sticky lg:top-32 overflow-hidden self-start">
                                ...
                                >
                                    <div className="absolute inset-0 bg-gradient-to-l from-black/80 via-transparent to-transparent lg:bg-gradient-to-l lg:from-transparent lg:to-mitake-black"></div>
                                </div>
                            </div>
                        </motion.div>
                    )}
